...
public class PDFGenerator {
    ...
    public void generate(int size, Long chatId) throws DocumentException, IOException {
        ...
        PdfWriter pdfWriter = PdfWriter.getInstance(document, new FileOutputStream("src/main/java/com/google/resources/PDFS/" + chatId + ".pdf"));
        document.open();
        document.setPageCount(size);
        for (int i = 0; i < size; i++) {
            Image image = Image.getInstance("src/main/java/com/google/resources/images/" + chatId + "_" + i + ".jpg");
    ...
    public void downloadImage(String url, Long chatId, int which) throws IOException {
        ...
        Path path = Paths.get("src/main/java/com/google/resources/images/" + chatId + "_" + which + ".jpg");
